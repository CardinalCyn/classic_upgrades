const originalRunes = {
  ...
  hands: [
    {
      ...
      name: "Victory Rush",
      description:
        "Instantly attack the target causing Attack power * 45 / 100 damage and healing you for 10% of your maximum health. Only usable within 20 sec after you kill an enemy that yields experience or honor.",
    ...
    },
    {
      ...
      name: "Devastate",
      description:
        "While you are in Defensive Stance and have a shield equipped, Sunder Armor also deals 100% weapon damage, increased by 10% per application of Sunder Armor already on the target.",
    ...
    },
    {
      ...
      name: "Quick Strike",
      description:
        "A reckless instant melee attack with your two-handed weapon dealing (Attack power * 15 / 100) to (Attack power * 25 / 100) physical damage. This ability benefits from and triggers all effects associated with Heroic Strike.<BR/>[DONT REALLY KNOW HOW THIS WORKS DOES IT INTERACT WITH HS QUEUE?]",
      iconname: "inv_axe_03",
      twohandonly: true,
      enable: 429765,
    },
  ...
  head: [
    ...
    },
    {
      ...
      name: "Endless Rage",
      description:
        "You generate 25% more Rage from all damage you deal.<br />[ASSUMED NO EFFECT ON REFUNDS]",
