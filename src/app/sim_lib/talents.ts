    ...
    t: [
      {
        ...
        c: 0,
        aura: function (count: number) {
          return { impheroicstrike: count };
        },
      },
      {
        i: 130,
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { impthunderclap: Math.pow(2, count - 1) };
        },
      },
      {
        i: 131,
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { abilitiescrit: count * 0.1 };
        },
      },
      {
        i: 132,
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { macestun: count == 5 ? 6 : count };
        },
      },
      {
        i: 123,
  ...
  },
  {
    ...
    t: [
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { impbattleshout: count * 0.05 };
        },
      },
      {
        i: 1581,
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { executecost: count == 2 ? 5 : count * 2 };
        },
      },
      {
        i: 155,
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { flurry: count == 0 ? 0 : 5 + count * 5 };
        },
      },
      {
        i: 167,
    ...
    t: [
      {
        ...
        aura: function (count: number) {
          return { block: count, blockragechance: count * 20 };
        },
      },
      {
        i: 138,
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { bloodragebonus: count == 2 ? 5 : count * 2 };
        },
      },
      {
        i: 140,
      ...
      },
      {
        ...
        aura: function (count: number) {
          return { impshieldwall: count == 2 ? 5 : count * 3 };
        },
      },
      {
        i: 152,
